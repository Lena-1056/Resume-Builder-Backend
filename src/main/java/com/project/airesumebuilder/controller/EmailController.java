...
public class EmailController {
    ...
    public ResponseEntity<Map<String, Object>> sendResumeByEmail(
        ...
        String emailBody = Objects.nonNull(message) ? message : "Please find my resume attachment.\n\n Best Regards";

        // Step 4: Call the service method to send email with an attachment
        emailService.sendEmailWithAttachment(recipientEmail, emailSubject, emailBody, pdfBytes, filename);

        // Step 5: return response
        response.put("success", true);
        response.put("message", "Email has been sent successfully " + recipientEmail);
